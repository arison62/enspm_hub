...
const FilterCard = ({
  ...
  // Valeur débouncée
  const debouncedLieuValue = useDebounce(localLieuValue, 5300);

  // Synchroniser avec les props quand elles changent (e.g., reset externe)
  useEffect(() => {
    const currentLieu =
      (filters.find((filter) => filter.id === "lieu")?.value as string) || "";
            ...
            <Field>
              <Select
                ...
                onValueChange={(value) => {
                  ...
                  onCurrentFilterChange?.(value as "emploi" | "formation");
                }}
              >
            ...
            <Field>
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  setFilters("lieu", e.target.value);
